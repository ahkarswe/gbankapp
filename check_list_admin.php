...
if($_SERVER['REQUEST_METHOD']=='GET'){
   ...
   do{ if($svr_error==1){
       // echo"<script> alert('you are INSUFFICIENT privilege to view this page.')</script>";
        ...
        <strong>You have not privilege to view this page contact your administrator.</strong> <a href="check_list_admin.php" class="btn btn-warning">ok</a>
      </div></div>
        ';
        //break;
...
<form  method="POST">
  ...
  <option >U Htet Wai Yan Lwin</option>
        ...
        <input type="date" class="form-control ms-2" id="endDate" name="endDate">
                <button class="btn btn-success" name="chkbtnDate">View/Close</button>
        </div>
            </div>
            ...
            <option>Select By Checking Area</option>
             <option>DC Room</option>
               <option>Power Room</option>
                ...
                <button class="btn btn-success" name="chkbtnArea">View/Close</button>
        </div>
        </div>
