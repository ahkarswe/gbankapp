...
<body>
  ...
  <textarea class="form-control"  name="comment" placeholder="တွေ့ရှိချက်အသေးစိတ်အား english မြန်မာ ကြိုက်နှစ်သက်ရာ ဖြင့်ဖော် ပြရန်"></textarea>
  </div>
  <div class="row mb-3">
...
<?php
    ...
    $sql="SELECT * FROM checklist ORDER BY date";
    $result = $conn->query($sql);
